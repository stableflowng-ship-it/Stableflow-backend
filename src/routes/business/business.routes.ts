...
import { createBankOpts, fetchBanksOpts, paycrestdBanks, verifyBank, verifyBankPaycrest } from "../../schemas/business/bank.schema";
...
const businessRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.get('/fetch-banks-paycrest', paycrestdBanks)
  fastify.get('/verify-bank-paycrest', verifyBankPaycrest)
};
